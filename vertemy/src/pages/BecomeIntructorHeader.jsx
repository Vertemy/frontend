...
import './BecomeIntructorHeader.css'
import Footer from '../pages/Footer'

const BecomeIntructorHeader = () => {
    const [activeTab, setActiveTab] = useState('course-pills-1');

  return (
    <div className='becomeintructor'>
    ...
    <div className="container">
      ...
      <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li className="nav-item" role="presentation">
          <button
            className={`nav-link ${activeTab === 'course-pills-1' ? 'active' : ''}`}
            onClick={() => setActiveTab('course-pills-1')}
          >
        ...
        <li className="nav-item" role="presentation">
          <button
            className={`nav-link ${activeTab === 'course-pills-2' ? 'active' : ''}`}
            onClick={() => setActiveTab('course-pills-2')}
          >
            Role of Instructor
          </button>
        </li>
        <li className="nav-item" role="presentation">
          <button
            className={`nav-link ${activeTab === 'course-pills-3' ? 'active' : ''}`}
            onClick={() => setActiveTab('course-pills-3')}
          >
            Start with Courses
          </button>
        </li>
      ...
      <div className="tab-content" id="pills-tabContent">
        ...
        {activeTab === 'course-pills-2' && (
          <div className="tab-pane fade show active" id="course-pills-2" role="tabpanel">
...
export default BecomeIntructorHeader