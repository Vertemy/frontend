  ...
  <div className="container">
    <div className="row g-4">
      ...
      <div className="col-10 text-center mx-auto position-relative">
        ...
        {/* Title */}
        <h1 className="position-relative fs-2">Vertemy Academy, designed with a focus on education, is dedicated to empowering learners and fostering a community of knowledge. </h1>
      </div>
      {/* Title and SVG END */}
    </div>
    {/* Images START */}
    <div className="row g-4 mt-0 mt-lg-5">
      ...
      <div className="col-6 col-md-4">
        <div className="row g-4">
          ...
          <div className="col-10 col-lg-6">
            <img className="rounded-4" src={community1} alt />
          </div>
          {/* Image */}
          <div className="col-12">
            <img className="rounded-4" src={comm2} alt />
          </div>
        </div>
      </div>
      {/* Center image */}
      <div className="col-6 col-md-4 position-relative">
        ...
        {/* Image */}
        <img className="rounded-4" src={comm3} alt />
      </div>
      {/* Right image */}
      <div className="col-md-4">
        <div className="row g-4">
          ...
          <div className="col-sm-6 col-md-12 col-lg-6">
            <img className="rounded-4" src={comm4} alt />
          </div>
        </div>
      </div>
    </div>
